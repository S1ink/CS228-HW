...
public interface Graph<V> {
	...
	public static <V> void BFTraversal(Graph<V> graph, Consumer<V> on_discovery, Consumer<V> on_finish) {
	...
	public static <V> void DFTraversal(Graph<V> graph,
	...
	public static class DGraph<V> implements Graph<V> {
